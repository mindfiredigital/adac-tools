...
async function main() {
  ...
  console.log(
    'ℹ️  Generating placeholder SVG icons using official GCP brand colors.'
  );
  console.log(
    '   For official icons, download from: https://cloud.google.com/icons'
  );
  ...
  console.log(
    `✅ icon-map.json written with ${Object.keys(iconMap).length} entries`
  );
  console.log(`\n📁 Icons:   ${ICONS_DIR}`);
